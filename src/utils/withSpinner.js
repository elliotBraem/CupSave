...
import {compose, withContext, getContext, mapProps, branch, renderComponent} from 'recompose';
...
export const spinnerWhile = condition =>
  branch(condition, renderComponent(<ActivityIndicator size="large" style={{marginTop: 100}} />));
